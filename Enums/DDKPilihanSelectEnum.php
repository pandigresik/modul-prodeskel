...
class DDKPilihanSelectEnum
{
    ...
    const STATUS_KEPEMILIKAN_RUMAH = [
        1 => 'Milik Sendiri',
        2 => 'Milik Orang Tua',
        3 => 'Milik Keluarga',
        4 => 'Sewa/Kontrak',
    ...
    const PENGUASAAN_ASET_TANAH_OLEH_KELUARGA = [
    ...
    const PERILAKU_HIDUP_BERSIH_SEHAT = [
    ...
    const KEBIASAAN_BEROBAT_BILA_SAKIT = [
        1 => 'Dukun Terlatih',
    ...
    const LEMBAGA_PEMERINTAHAN_YANG_DIIKUTI_ANGGOTA = [
        1 => 'Kepala Desa/Lurah',
