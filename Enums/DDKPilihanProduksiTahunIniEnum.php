...
{
    const TANAMAN_PANGAN = 'Tanaman Pangan';
    const BUAH_BUAHAN = 'Buah-Buahan';
    const TANAMAN_OBAT = 'Tanaman Obat';
    const TANAMAN_PERKEBUNAN = 'Tanaman Perkebunan';
    const HASIL_HUTAN = 'Hasil Hutan';
    const PENGOLAHAN_HASIL_TERNAK = 'Pengolahan Hasil Ternak';
    const PERIKANAN = 'Perikanan';
    ...
    final public static function dataWithKode($data = null) : array
    {
        ...
        foreach($data as $key_kategori => $komoditas){
            $kode_komoditas = 1;
            $tmp[$key_kategori] = array_map(static function($item) use($key_kategori, &$kode_komoditas){
