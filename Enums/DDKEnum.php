...
class DDKEnum
{
    ...
    // path dan file
    const PATH_TEMPLATE             =  'Modules'. DIRECTORY_SEPARATOR.'Prodeskel'. DIRECTORY_SEPARATOR. 'template-prodeskel' . DIRECTORY_SEPARATOR;
    ...
    */
    ...
    const KODE_JUMLAH_PENGHASILAN_PERBULAN  = 'k1_1'; //#
    const KODE_JUMLAH_PENGELUARAN_PERBULAN  = 'k1_2'; //#
    const KODE_STATUS_KEPEMILIKAN_RUMAH     = 'k1_3'; //select
    const KODE_SUMBER_AIR_MINUM             = 'k1_4'; //checkbox
    const KODE_SUMBER_AIR_MINUM_CHECKBOX    = 'k1_4#'; //#
    const KODE_KEPEMILIKAN_LAHAN            = 'k1_5'; //checkbox
    const KODE_KEPEMILIKAN_LAHAN_CHECKBOX   = 'k1_5#'; //#
    const KODE_PRODUKSI_TAHUN_INI           = 'k1_6';
    const KODE_KATEGORI_PRODUKSI_TAHUN_INI = [
    ...
    const KODE_KEPEMILIKAN_JENIS_TERNAK_KELUARGA_TAHUN_INI = 'k1_7'; //multi input jumlah
    const KODE_ALAT_PRODUKSI_BUDIDAYA_IKAN                 = 'k1_8'; //multi input jumlah
    const KODE_PEMANFAATAN_DANAU_SUNGAI_WADUK_SITU_MATA_AIR_OLEH_KELUARGA = 'k1_9'; //multiple select
    const KODE_LEMBAGA_PENDIDIKAN_YANG_DIMILIKI_KELUARGA_KOMUNITAS = 'k1_10'; //multiple select
    const KODE_PENGUASAAN_ASET_TANAH_OLEH_KELUARGA = 'k1_11'; //select
    const KODE_ASET_SARANA_TRANSPORTASI_UMUM = 'k1_12'; //multiple select
    const KODE_ASET_SARANA_PRODUKSI         = 'k1_13'; //multiple select
    const KODE_ASET_PERUMAHAN_DINDING       = 'k1_14a'; //multiple select
    const KODE_ASET_PERUMAHAN_LANTAI        = 'k1_14b'; //multiple select
    const KODE_ASET_PERUMAHAN_ATAP          = 'k1_14c'; //multiple select
    const KODE_ASET_LAINNYA                 = 'k1_15'; //multiple select
    const KODE_KUALITAS_IBU_HAMIL           = 'k1_16'; //multiple select
    const KODE_KUALITAS_BAYI                = 'k1_17'; //multiple select
    const KODE_KUALITAS_TEMPAT_PERSALINAN   = 'k1_18a'; //multiple select
    const KODE_KUALITAS_PERTOLONGAN_PERSALINAN = 'k1_18b'; //multi input jumlah
    const KODE_CAKUPAN_IMUNISASI            = 'k1_19'; //multiple select
    const KODE_PENDERITA_SAKIT_DAN_KELAINAN = 'k1_20'; //multiple select
    const KODE_PERILAKU_HIDUP_BERSIH_SEHAT  = 'k1_21'; //select
    const KODE_POLA_MAKAN_KELUARGA          = 'k1_22'; //select
    const KODE_KEBIASAAN_BEROBAT_BILA_SAKIT = 'k1_23'; //select
    const KODE_STATUS_GIZI_BALITA           = 'k1_24'; //select
    const KODE_JENIS_PENYAKIT_ANGGOTA_KELUARGA = 'k1_25'; //multiple select
    const KODE_KERUKUNAN                    = 'k1_26'; //multiple select
    const KODE_PERKELAHIAN                  = 'k1_27'; //multiple select
    const KODE_PENCURIAN                    = 'k1_28'; //multiple select
    const KODE_PENJARAHAN                   = 'k1_29'; //multiple select
    const KODE_PERJUDIAN                    = 'k1_30'; //multiple select
    const KODE_PEMAKAIAN_MIRAS_DAN_NARKOBA  = 'k1_31'; //multiple select
    const KODE_PEMBUNUHAN                   = 'k1_32'; //multiple select
    const KODE_PENCULIKAN                   = 'k1_33'; //multiple select
    const KODE_KEJAHATAN_SEKSUAL            = 'k1_34'; //multiple select
    const KODE_KEKERASAN_DALAM_KELUARGA_ATAU_RUMAH_TANGGA = 'k1_35'; //multiple select
    const KODE_MASALAH_KESEJAHTERAAN_KELUARGA = 'k1_36'; //multiple select

    // ANGGOTA
    const KODE_NO_URUT          = 'k2_1_1'; //#
    const KODE_NIK              = 'k2_1_2'; //#
    const KODE_NAMA_LENGKAP     = 'k2_1_3'; //#
    const KODE_AKTE_KELAHIRAN   = 'k2_1_4'; //#
    const KODE_JENIS_KELAMIN    = 'k2_1_5'; //#
    const KODE_HUB_KK           = 'k2_1_6'; //#
    const KODE_TEMPAT_LAHIR     = 'k2_1_7'; //#
    const KODE_TANGGAL_LAHIR    = 'k2_1_8'; //#
    const KODE_TANGGAL_PENCATATAN_LAHIR = 'k2_1_9'; //input
    const KODE_STATUS_PERKAWINAN= 'k2_1_10'; //#
    const KODE_AGAMA            = 'k2_1_11'; //#
    const KODE_GOL_DARAH        = 'k2_1_12'; //#
    const KODE_KEWARGANEGARAAN  = 'k2_1_13'; //#
    const KODE_PENDIDIKAN       = 'k2_1_14'; //#
    const KODE_PEKERJAAN        = 'k2_1_15'; //#
    const KODE_NAMA_BAPAK_IBU_KANDUNG = 'k2_1_16'; //#
    const KODE_AKSEPTOR_KB      = 'k2_1_17'; //multiple select
    const KODE_CACAT_FISIK      = 'k2_2a'; //multiple select
    const KODE_CACAT_MENTAL     = 'k2_2b'; //multiple select
    const KODE_KEDUDUKAN_ANGGOTA_SEBAGAI_WAJIB_PAJAK_DAN_RETRIBUSI = 'k2_3'; //multiple select
    const KODE_LEMBAGA_PEMERINTAHAN_YANG_DIIKUTI_ANGGOTA = 'k2_4'; // select
    const KODE_LEMBAGA_KEMASYARAKATAN_YANG_DIIKUTI_ANGGOTA = 'k2_5'; //multiple select
    const KODE_LEMBAGA_EKONOMI_YANG_DIMILIKI_ANGGOTA = 'k2_6'; //multiple select
    const KODE_PRODUKSI_BAHAN_GALIAN_YANG_DIMILIKI_ANGGOTA = 'k2_7'; //table prodeskel_ddk_bahan_galian
