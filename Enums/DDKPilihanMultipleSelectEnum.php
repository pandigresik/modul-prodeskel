...
class DDKPilihanMultipleSelectEnum
{
    ...
    public static function semuaKode()
    {
        return [
    ...
    const PEMANFAATAN_DANAU_SUNGAI_WADUK_SITU_MATA_AIR_OLEH_KELUARGA = [
        1 => 'Usaha Perikanan',
    ...
    const LEMBAGA_PENDIDIKAN_YANG_DIMILIKI_KELUARGA_KOMUNITAS = [
    ...
    const ASET_SARANA_TRANSPORTASI_UMUM = [
    ...
    const KUALITAS_TEMPAT_PERSALINAN = [
    ...
    const PENDERITA_SAKIT_DAN_KELAINAN = [
        1 => 'Muntaber',
        2 => 'Demam Berdarah',
        3 => 'Kolera',
        4 => 'Polio',
    ...
    const JENIS_PENYAKIT_ANGGOTA_KELUARGA = [
        1 => 'Jantung',
        2 => 'Lever',
        3 => 'Paru-paru',
        4 => 'Kanker',
    ...
    const PEMAKAIAN_MIRAS_DAN_NARKOBA = [
    ...
    const KEKERASAN_DALAM_KELUARGA_ATAU_RUMAH_TANGGA = [
    ...
    const MASALAH_KESEJAHTERAAN_KELUARGA = [
    ...
    const KEDUDUKAN_ANGGOTA_SEBAGAI_WAJIB_PAJAK_DAN_RETRIBUSI = [
    ...
    const LEMBAGA_KEMASYARAKATAN_YANG_DIIKUTI_ANGGOTA = [
        1 => 'Pengurus RT',
    ...
    const LEMBAGA_EKONOMI_YANG_DIIKUTI_ANGGOTA = [
        1 => 'Koperasi',
